...
insert into role_permissions(roles_roleName, permissions_id) values('DEVELOPER', 6);
insert into role_permissions(roles_roleName, permissions_id) values('DEVELOPER', 7);
insert into role_permissions(roles_roleName, permissions_id) values('DEVELOPER', 8);
