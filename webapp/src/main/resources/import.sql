...
insert into permission(id, permission) values(0, 'admin:everything');
insert into permission(id, permission) values(1, 'project:everything');
insert into permission(id, permission) values(2, 'project:view');
insert into permission(id, permission) values(3, 'project:add_bug');
insert into permission(id, permission) values(4, 'project:edit_bug');
insert into permission(id, permission) values(5, 'project:add_member');
insert into permission(id, permission) values(6, 'project:delete');
insert into permission(id, permission) values(7, 'project:update');
insert into permission(id, permission) values(8, 'project:create');

insert into role_permissions(role_roleName, permissions_id) values('ADMIN', 0);
insert into role_permissions(role_roleName, permissions_id) values('PM', 1);
insert into role_permissions(role_roleName, permissions_id) values('DEVELOPER', 2);
insert into role_permissions(role_roleName, permissions_id) values('DEVELOPER', 3);
insert into role_permissions(role_roleName, permissions_id) values('DEVELOPER', 4);
insert into role_permissions(role_roleName, permissions_id) values('DEVELOPER', 6);
insert into role_permissions(role_roleName, permissions_id) values('DEVELOPER', 7);
insert into role_permissions(role_roleName, permissions_id) values('DEVELOPER', 8);
insert into role_permissions(role_roleName, permissions_id) values('EXTERNAL', 2);
insert into role_permissions(role_roleName, permissions_id) values('EXTERNAL', 3);
insert into role_permissions(role_roleName, permissions_id) values('EXTERNAL', 4);
insert into role_permissions(role_roleName, permissions_id) values('GUEST', 2);
